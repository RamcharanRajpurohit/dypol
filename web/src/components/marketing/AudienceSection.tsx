    ...
    <section className="container-x reveal hairline border-t py-28 md:py-36">
      ...
      <div className="grid grid-cols-12 gap-x-10 gap-y-14">
        <div className="col-span-12 lg:col-span-6">
          <div
            className="bg-surface hairline h-full rounded-[10px] border p-9"
            style={{ boxShadow: "0 1px 0 rgb(20 17 13 / 0.02)" }}
          >
            <div className="caption mb-4">Founders & CTOs</div>
            <h3 className="display mb-5 text-[34px] leading-[1.1]" style={{ letterSpacing: "-0.01em" }}>
              You stopped reading the dashboard six weeks ago.
            </h3>
            <p className="text-ink2 mb-8 text-[16.5px] leading-relaxed">
              DyPol replaces the ritual of "checking the metrics" with a one-line question. Ask
              once a week. Get a paragraph back. Forward it to the board.
            </p>
        ...
        <div className="col-span-12 lg:col-span-6 lg:pt-10">
          <div className="hairline border-t border-b px-1 py-9">
            ...
            <p className="text-ink2 mb-8 text-[16.5px] leading-relaxed">
              Walk into reviews knowing what each engineer shipped, who they helped, and where
              they got stuck. Not as a scorecard &mdash; as a way to ask better questions.
            </p>
            <figure>
              <blockquote className="italic-serif text-ink mb-3 text-[20px] leading-[1.35]">
                "{`{quote from design partner}`}"
